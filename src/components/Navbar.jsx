...
const Navbar = () => {
  ...
  return (
    <div className="text-[#ff2323] items-center h-20 flex justify-between border-[#ff0000] max-w-[1240px] mx-auto px-4 border-b-2 font-bold fixed left-0 right-0 top-0 bg-slate-800">
